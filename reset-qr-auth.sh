...
# Script para reset da autenticação do bot_marc
# Autor: bot_marc
# Versão: 0.9.0-BETA

echo "🤖 bot_marc - Reset da Autenticação"
echo "====================================="
echo ""

if [ ! -d "assets" ]; then
    echo "❌ Erro: Você deve executar este script no diretório raiz do bot_marc"
